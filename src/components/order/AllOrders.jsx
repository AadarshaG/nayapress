      ...
      <TableBody>
        {
            ...
            orders?.map((order, i) => (
                <TableRow key={i + 1}>
                    ...
                    <TableCell>
                    <span className="text-sm">{order?.advanced_payment}</span>
                    </TableCell>
                    <TableCell>
                    <span className="text-sm font-semibold">Rs.{(order?.unit_price*order?.unit_pieces)-(order?.advanced_payment)-(order?.total_payment)} </span>
                    </TableCell>
                    <TableCell>
                    <span className="text-sm font-semibold">Rs.{(order?.unit_price*order?.unit_pieces)} </span>
                    </TableCell>
                    <TableCell>
                    <span className="text-sm font-semibold">{order?.delivery_date.split('T')[0]} </span>
                    </TableCell>
